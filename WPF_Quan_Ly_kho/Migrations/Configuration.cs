namespace WPF_Quan_Ly_kho.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<WPF_Quan_Ly_kho.DAL.StorageContext>
    {
        public Configuration()
        {
            AutomaticMigrationsEnabled = true;
            AutomaticMigrationDataLossAllowed = true;
            ContextKey = "WPF_Quan_Ly_kho.DAL.StorageContext";
            TargetDatabase = new DbConnectionInfo("StorageContext");
        }

        protected override void Seed(WPF_Quan_Ly_kho.DAL.StorageContext context)
        {
            ...
            {
                new Material{ID=1, DisplayName="Xi Mang", IDUnit=1, IDSuplier=1, QRCode="no", BarCode="no"},
                new Material{ID=2, DisplayName="Gach", IDUnit=4, IDSuplier=2, QRCode="no", BarCode="no"},
                new Material{ID=3, DisplayName="Cat", IDUnit=2, IDSuplier=3, QRCode="no", BarCode="no"}
            };
